...
public class JedisUtil {
	@Autowired
	private static Environment erm;
	...
	private static void initialConfig(){
        try {
            HOST = erm.getProperty("spring.redis.host");
            PORT = Integer.parseInt(erm.getProperty("spring.redis.port"));
            TIMEOUT = Integer.parseInt(erm.getProperty("spring.redis.timeout"));
            MAX_WAIT = Integer.parseInt(erm.getProperty("spring.redis.jedis.pool.max-active"));
            MAX_ACTIVE = Integer.parseInt(erm.getProperty("spring.redis.jedis.pool.max-active"));
            MAX_IDLE = Integer.parseInt(erm.getProperty("spring.redis.jedis.pool.max-idle"));
        } catch (Exception e) {
