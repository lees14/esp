 ...
 * @version
 * 
 * 			| 类描述：获取和判断文件头信息 |--文件头是位于文件开头的一段承担一定任务的数据，一般都在开头的部分。
 ...
 *          docx 和 xlsx 头文件一样 doc 和 xls 一样
 * 
 *          | 2007版本的office 头文件都是一样的 docx xlsx pptx | 2003版本的office 头文件都是一样的 doc
 *          xls
 */
...
//		System.out.println(builder.toString());
	...
	public static void main(String[] args) throws Exception {
		String fileType = getFileType("E:/lxzk/zjk/file/11.pptx");
		String fileType1 = getFileType("E:/lxzk/zjk/file/其他单位20180828.xlsx");
